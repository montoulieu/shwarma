    ...
    <div className="min-h-screen flex flex-col content-center justify-center text-center text-blue-400 text-lg p-3">
      <NextSeo
        ...
        openGraph={{
          ...
          title: "shwarma - Loveworthy Live EP Premiere",
          description:
            "Loveworthy Live EP premiering Valentines Day at 1PM MST",
          images: [
            {
      ...
      <div className="flex flex-col md:flex-row font-bold md:mx-auto ">
        <a
          ...
          className="border-2 border-blue-400 text-lg rounded-lg p-5 mb-3 md:mb-0 w-full md:w-64 md:mr-3"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          ...
          className="border-2 border-blue-400 text-lg rounded-lg p-5 w-full md:w-64"
          target="_blank"
          rel="noreferrer"
        >

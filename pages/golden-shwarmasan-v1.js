  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="text-center text-yellow-300 max-w-sm">
        ...
        <img
          src="/images/bub-bubs.jpg"
          alt="bub bubs"
          className="rounded-xl my-5"
        />
        <h2 className="mb-2">
          As I peer into the depths of my fizzy soda, I see a kaleidoscope of
          bubbles swirling and dancing, each one like a tiny universe unto
          itself. And as I watch, I can&apos;t help but wonder: are these
          bubbles really just bubbles, or are they portals to another dimension?
          Could it be that time itself is trapped inside these bubbles,
          expanding and contracting with every fizzy burst? Are we all just tiny
          bubbles in the grand cosmic soda of existence, swirling and bubbling
          and popping in a never-ending dance of life and death? Or perhaps time

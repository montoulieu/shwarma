  ...
  return (
    <div className="h-full">
      ...
      <main className="container mx-auto">
        ...
        <LatestLivestream />
        <GalleryPhotos />
        <footer className="flex flex-col items-center text-blue-100 pb-5">
          <a
            href="mailto:shwarmaband@gmail.com"
            className="mx-auto mb-6 border border-blue-200 blue-hover hover:bg-blue-200 hover:bg-opacity-10 p-2 rounded-lg"
          >
            Contact
          </a>

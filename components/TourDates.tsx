      ...
      <div className="section-content">
        ...
        <div className="glass-card p-6 md:p-10 max-w-6xl mx-auto">
          ...
          <a
            ...
            data-date-border-color="rgba(112,255,0,0.5)"
            ...
            data-event-ticket-cta-bg-color="rgba(112,255,0,1)"
            data-event-ticket-cta-border-color="rgba(112,255,0,1)"
            ...
            data-event-rsvp-cta-border-color="rgba(112,255,0,0.5)"
            ...
            data-follow-section-cta-bg-color="rgba(112,255,0,1)"
            data-follow-section-cta-border-color="rgba(112,255,0,1)"
            ...
            data-play-my-city-cta-border-color="rgba(112,255,0,0.5)"
